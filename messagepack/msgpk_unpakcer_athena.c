/*************************************************************************
    > File Name: msgpk_unparker.c
    > Author: shuaixiang
    > Mail: shuaixiang@yuewen.com
    > Created Time: Fri 11 Mar 2016 03:24:11 AM UTC
 ************************************************************************/
#include "msgpk_unpacker_athena.h"
...
static void msgpk_unpack_dispatcher_athena(struct context *ctx);
        ...
        *off += 1;
        ...
        for(i = 0; i < len; i++){
            ...
            if(0 == i)
                ...
                ctx->node->next = new_node;
            ctx->node = new_node;
            msgpk_unpack_dispatcher_athena(ctx);
        }
        return;
    }
    if(head == 0xDC){
...
struct msgpk_object * msgpk_message_unpacker_athena(ubyte_t *buf, int len){
