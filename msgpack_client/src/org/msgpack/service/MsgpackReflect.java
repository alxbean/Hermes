...
public class MsgpackReflect {
	...
	public static PropertyDescriptor[] getBeanPropertyDescriptor(
			ClassLoader cl, String className) throws ClassNotFoundException,
	...
	public static <T> T newInstance(Class<T> cls, Class<?>[] parameterTypes,
